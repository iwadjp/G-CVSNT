...
1. [GitHub Releases](https://github.com/iwadjp/G-CVSNT/releases/tag/v2.5.05.3744-win11-x64-r2) から `TortoiseCVS-x64-Setup.exe` をダウンロード
...
1. Download `TortoiseCVS-x64-Setup.exe` from [GitHub Releases](https://github.com/iwadjp/G-CVSNT/releases/tag/v2.5.05.3744-win11-x64-r2)
